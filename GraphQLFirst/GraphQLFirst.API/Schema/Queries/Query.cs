...
namespace GraphQLFirst.API.Schema.Queries
{
    public class Query
    {
        ...
        /** It's important to highlight that banana cake don't use the default names as 'Get' or 'Async'. So when
         you're calling your function like GetCourseByIdAsync, just put courseById*/
        ...
        public string Instructions() => "Lavínia :)";
    }
